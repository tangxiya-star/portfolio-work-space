...
export const theme = {
  ...
  fonts: {
    ...
    bodyMedium: 'Plus Jakarta Sans',
    bodySemibold: 'Plus Jakarta Sans',
    bodyBold: 'Plus Jakarta Sans',
    mono: 'JetBrains Mono',
    monoBold: 'JetBrains Mono',
  },
  ...
  // ── Spacing (8pt grid) ──────────────────────────────
  // 7 steps. Started with 9; xxs(2) merged into xs(4) (2px wasn't distinct
  // at body-text scale) and 4xl(64) cut (never referenced in production).
  spacing: {
    xs: 4,
    sm: 8,
    md: 12,
