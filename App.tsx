        ...
        <div className="max-w-6xl mx-auto px-6 md:px-8 pt-14 pb-16 space-y-24">
          ...
          <div className="flex flex-col md:flex-row gap-12 md:gap-20 items-start">
            <div className="md:w-2/5 w-full shrink-0">
              ...
              <div className="h-[3px] bg-[#C9A96E] w-1/3" />
            </div>
              ...
              {pillars.map((p) => (
                <div key={p.index} className="border-t border-[#E8E8E8] py-10 grid grid-cols-1 md:grid-cols-[120px_1fr_1fr] gap-8 md:gap-12 items-start">
                  ...
                  <div className="flex md:flex-col items-center md:items-start gap-3">
                    ...
                    <span className="font-sans text-[11px] uppercase tracking-[0.22em] font-semibold border border-[#C9A96E] px-2 py-0.5 text-[#111111]">{p.label}</span>
                  </div>
                  {/* Title */}
    ...
    <div className="page-geist relative min-h-screen pb-24 selection:bg-[#F7DA21] selection:text-black overflow-x-hidden">
      ...
      <main className="max-w-6xl mx-auto px-6 md:px-8 relative mt-14">
        ...
        <section className="pt-12 pb-10">
          <div className="pt-8">
            <h1 className="font-serif font-medium text-[#111111] leading-tight tracking-[-0.02em] mb-5"
              style={{ fontSize: 'clamp(2rem, 4vw, 3rem)' }}>
              I'm Holly — a design engineer<br />who ships in code.
            </h1>
            <p className="font-sans text-[#111111] leading-[1.5]"
              style={{ fontSize: 'clamp(15px, 1.4vw, 18px)' }}>
              0→1 specialist. 3 hackathons won. I wire agents that work.
            </p>
          </div>
        </section>
      ...
      {/* ── Selected Work grid — frosted-glass cards ────────────── */}
      <div id="work" className="max-w-[1280px] mx-auto px-6 md:px-8 grid grid-cols-1 md:grid-cols-2 gap-y-10 gap-x-6 md:gap-x-8">
